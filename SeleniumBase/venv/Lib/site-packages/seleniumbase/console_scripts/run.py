...
def show_extract_objects_usage():
    ...
    print('           "pageObjects.py" file in the same folder as the tests.')
    print("")
...
def show_inject_objects_usage():
    ...
    print("  Output:")
    print('           Takes the page objects found in the "pageObjects.py"')
...
def show_objectify_usage():
    ...
    print('           "pageObjects.py", supporting the Page Object Pattern.')
    print("")
...
def show_revert_objects_usage():
    ...
    print('           selectors stored in the "pageObjects.py" file.')
    print("")
